...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'fixed-assets', loadComponent: () => import('./pages/fixed-assets/fixed-assets').then(m => m.FixedAssetsComponent) },
      { path: 'meeting-room', loadComponent: () => import('./pages/meeting-room/meeting-room').then(m => m.MeetingRoomComponent) },
    ]
  },
