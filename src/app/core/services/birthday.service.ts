...
export class BirthdayService {
  ...
  private mockBirthdays: BirthdayResponse[] = [
    ...
    { firstName: 'Jair',            lastName: 'Guardo Palacios',         birthdayDate: '1991-02-17', sede: 'San Andrés' },
    { firstName: 'Jim',             lastName: 'Oneill Henry',            birthdayDate: '1976-12-29', sede: 'San Andrés' },
    { firstName: 'Jhon',            lastName: 'Orellano Altamirano',     birthdayDate: '1979-01-26', sede: 'San Andrés' },
    { firstName: 'Welinton',        lastName: 'Cardales Hernández',      birthdayDate: '1977-11-07', sede: 'San Andrés' },
    { firstName: 'Doris',           lastName: 'Blanco de la Asunción',   birthdayDate: '1977-09-09', sede: 'San Andrés' },
